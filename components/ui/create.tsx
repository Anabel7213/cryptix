      ...
      {showButton && (
        <>
          <div
            ...
            className="text-white cursor-pointer hover:bg-[#5e2ac5] transition-all w-fit absolute bottom-24 left-1/2 -translate-x-1/2 bg-[#8656E4] shadow-[0px_6px_10px_0px_rgba(182,127,229,0.75)] p-4 rounded-full"
          >
            <Plus size={32} />
          </div>
